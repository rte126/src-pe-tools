  ...
  <tr>
    <td>
      ...
      <table border=0 cellpadding=4 cellspacing=1 width="100%">
				<tr> 
				  <th align="center" colspan="3" class="tableheading">Actions</th>
				</tr>
        <!-- table row showing column headings -->
        <tr> 
          <th nowrap class="tableheading">Order</th>
          <th align="center" class="tableheading">Operation</th>
          <th nowrap align="center" class="tableheading">Service</th>
        </tr>
